...
import org.digitalthinking.repositories.ProductRepositoryEntityManager;
...
@Path("/product-entity-manager")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class ProductApiEntityManager {
 @Inject
 ProductRepositoryEntityManager pr;
